...
create_page_summary <- function(
  ...
  grid.arrange(
    ...
    arrangeGrob(
      ...
      create_summary_report(data, state, year, gVariables[x1,Name],
      ...
      if(show2){
        create_summary_report(data, state, year, gVariables[x2,Name],
      ...
      if(show3){
        create_summary_report(data, state, year, gVariables[x3,Name],
    ...
    arrangeGrob(
      ...
      rectGrob(gp=gpar(fill="white", col = "white")),
      suppressWarnings(create_travel_yoy_density(data, state, year, year_compare,
                                gVariables[x1,Name],
    ...
    arrangeGrob(
      rectGrob(gp=gpar(fill=color, col = "white")),
      rectGrob(gp=gpar(fill="white", col = "white")),
      create_travel_data_yoy(data, state, year, year_compare,
