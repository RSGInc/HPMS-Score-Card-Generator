...
view_variable(data.list, variable = gVariables[Label == 'Lane Width', Name])
view_variable(data.list, variable = gVariables[Label == 'Through Lanes', Name])


state = 'CO'
data.list <- getStateDataSets(state, year_selection, year_compare)

view_variable(data.list, variable = gVariables[Label == 'Managed Lanes', Name])
view_variable(data.list, variable = gVariables[Label == 'Number of Signalized Intersections', Name])
